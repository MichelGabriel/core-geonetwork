...
(function() {
  ...
  goog.require('gn_search_isric_config');
  goog.require('gn_search_isric_directive');

  var module = angular.module('gn_search_isric',
      ['gn_search', 'gn_search_isric_config',
       'gn_search_isric_directive', 'gn_related_directive',
